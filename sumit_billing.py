#initially, I am importing all Required modules
from tkinter import *
...
class Front:
    def __init__(self, window):
        ...
        # ===================Main label=============
        self.l1 = Label(self.top, text="NEW BARRACKPORE NAVACHETNA RESTAURANT", font=self.font1, bg="#EEF5DB", bd=8, fg="tomato",
                        justify=CENTER)
        self.l1.place(x=235, y=0)
        # =============Right Canvas==============
        self.right = Canvas(window, width=1366, height=520, bd=5, bg="#olive", relief=RAISED)
        self.image = ImageTk.PhotoImage(Image.open("2.jpg"))
        id = self.right.create_image(680, 250, image=self.image)
        text = self.right.create_text(400, 540, fill="#EEF5DB", font=("cinzel", 27, "bold"),
                                      text="WELCOME TO NEW BARRACKPORE NAVACHETNA RESTAURANT ")
        self.right.place(x=0, y=220)

        # ==================left  Frame============
        self.left = Frame(window, width=1366, height=100, bd=5, bg="olive", relief=RAISED)
        self.left.propagate(0)
        self.left.place(x=0, y=120)
        # =====================button=============
        self.button1 = Button(self.left, text="BILL COUNTER", width=15, height=3, bd=8, bg="olive",
                              fg="#EEF5DB", command=self.call)
        self.button1.place(x=450, y=10)
        self.button2 = Button(self.left, text="CALCULATOR", width=15, height=3, bd=8, bg="olive",
                              fg="#EEF5DB", command=self.cal)
        self.button2.place(x=900, y=10)
        self.button3 = Button(self.left, text="Exit", width=15, height=3, bd=8, bg="#olive",
        ...
        self.button5 = Button(self.left, text="MENU", width=15, height=3, bd=8, bg="olive",
                              fg="#EEF5DB", command=self.rate)
        self.button5.place(x=600, y=10)
        self.button6 = Button(self.left, text="SEARCH BILL", width=15, height=3, bd=8, bg="olive",
        ...
        def call(self):
            ...
            root = Tk()
            obj1 = Restra(root)
            root.title("BARRACKPORE NAVACHETNA RESTAURANT")
...
class Restra(Front):
    def __init__(self, root):
        ...
        self.top.place(x=0, y=0)
        # ===================Main label=============
        self.l1 = Label(self.top, text="NEW BARRACKPORE NAVACHETNA  RESTAURANT", font=self.font1,
        ...
        # ======================Button=================
        # =============================================
        self.add1 = Button(self.menu, text="ADD", width=5, height=1, bd=6, bg="olive",
                           fg="#EEF5DB", command=self.vgadd)
        self.add1.place(x=650, y=50)
        self.add2 = Button(self.menu, text="ADD", width=5, height=1, bd=6, bg="olive",
                           fg="#EEF5DB", command=self.nvgadd)
        self.add2.place(x=650, y=95)
        self.add3 = Button(self.menu, text="ADD", width=5, height=1, bd=6, bg="olive",
                           fg="#EEF5DB", command=self.sweadd)
        self.add3.place(x=650, y=145)
        self.add4 = Button(self.menu, text="ADD", width=5, height=1, bd=6, bg="olive",
                           fg="#EEF5DB", command=self.dadd)
        self.add4.place(x=650, y=195)
        self.add5 = Button(self.menu, text="ADD", width=5, height=1, bd=6, bg="olive",
        ...
        # ====================button==================
        self.menu = Button(self.button, text="MENU", width=13, height=4, bd=5, bg="olive",
                           fg="#EEF5DB", command=self.rate)
        self.menu.place(x=0, y=-2)
        self.cal = Button(self.button, text="CALCULATOR", width=13, height=4, bd=5, bg="olive",
                          fg="#EEF5DB", command=self.cal)
        self.cal.place(x=0, y=73)
        self.search = Button(self.button, text="RESET", width=13, height=4, bd=5, bg="olive",
        ...
        # =====================label====================
        self.labelcd = Label(self.left, text="CUSTOMER INFORMATION", bg="olive",
                             font=self.font2, fg="#EEF5DB")
        self.labelcd.place(x=0, y=20)
        self.labelcn = Label(self.left, text="CUSTOMER NAME:-", bg="olive",
                             font=self.font4, fg="#EEF5DB")

        self.labelcd.place(x=0, y=80)
        self.labelcn = Label(self.left, text="CUSTOMER AGE:-", bg="olive",
                             font=self.font4, fg="#EEF5DB")
        self.labelcd.place(x=0, y=140)
        self.labelcn = Label(self.left, text="CUSTOMER ADDRESS:-", bg="olive",
                             font=self.font4, fg="#EEF5DB")
        self.labelcd.place(x=0, y=200)
        self.labelcn = Label(self.left, text="CUSTOMER CONTACT:-", bg="olive",
                             font=self.font4, fg="#EEF5DB")
        self.labelcn.place(x=0, y=260)
        self.labelcm = Label(self.left, text="BILL NUMBER:-", bg="olive",
                             font=self.font4, fg="#EEF5DB")
        self.labelcm.place(x=0, y=320)
        self.labelpm = Label(self.left, text="PAYMENT METHOD:-", bg="olive",
                             font=self.font4, fg="#EEF5DB")
        ...
        # =============================Bill=====================
        # ======================================================
        self.bill = Frame(root, width=760, height=270, bd=5, bg="olive", relief=RAISED)
        self.bill.propagate(0)
        self.bill.place(x=0, y=570)
        # ================Recipt=============
        self.label1 = Label(self.bill, text="SUB TOTAL=", font=self.font2, bg="olive", fg="#EEF5DB")
        self.label1.place(x=20, y=10)
        self.sb = Entry(self.bill, bd=5, width=8)
        self.sb.place(x=230, y=18)
        self.sb.insert(END, int(0))
        self.label2 = Label(self.bill, text="discount=", font=self.font2, bg="olive", fg="#EEF5DB")
        self.label2.place(x=330, y=10)
        self.tax = Entry(self.bill, bd=5, width=8)
        self.tax.place(x=420, y=18)
        self.label3 = Label(self.bill, text="TOTAL=", font=self.font2, bg="olive", fg="#EEF5DB")
        self.label3.place(x=520, y=10)
        self.total = Entry(self.bill, bd=5, width=8)
        self.total.place(x=660, y=18)
        self.L1 = Label(self.bill, text="PORJECT MADE BY:- SUMIT KUMAR ",
...
# ==================button=========
    ...
    def insert(self):
        ...
        if str1 == "":
            ...
            self.ric.insert(END, str("\t     NEW BARRACKPORE NAVACHETNA RESTAURANT"))
    ...
    def rate(self):
        ...
        class Menu:
            def __init__(self, root):
                ...
                self.lb1 = Label(self.veg, text="SHAHI PANEER\t\t 250      KADAI PANEER\t 320", font=self.font4,
                                 bg="#4F6367",
                                 fg="#EEF5DB", justify=RIGHT)
                self.lb1.place(x=30, y=80)
                self.lb2 = Label(self.veg, text="PANEER KEEMA\t\t 220      MALIA KOFTA\t 180", font=self.font4,
                                 bg="#4F6367",
                                 fg="#EEF5DB", justify=RIGHT)
                ...
                self.dish = Label(self.ngveg, text="DISH\t\t\t RATE  DISH \t\t RATE", font=self.font5, bg="#4F6367",
                                  fg="#EEF5DB", justify=RIGHT)
                self.dish.place(x=30, y=50)
                self.lb1 = Label(self.ngveg, text="CHICKEN ACHAARI\t 250      MUTTON TANGRI\t 320", font=self.font4,
                                 bg="#4F6367",
                                 fg="#EEF5DB", justify=RIGHT)
                self.lb1.place(x=30, y=80)
                ...
                self.dish = Label(self.swee, text="DISH\t\t\t RATE  DISH \t\t RATE", font=self.font5, bg="#4F6367",
                                  fg="#EEF5DB", justify=RIGHT)
                self.dish.place(x=30, y=50)
                self.lb1 = Label(self.swee, text="GULAB JAMUN\t\t 10      RASMALAYI\t\t 25", font=self.font4,
                                 bg="#4F6367",
                                 fg="#EEF5DB", justify=RIGHT)
                self.lb1.place(x=30, y=80)
                self.lb2 = Label(self.swee, text="MOONG KI DAL KA HALWA\t 20       ICE CREAM\t\t 40", font=self.font4,
                                 bg="#4F6367",
                                 fg="#EEF5DB", justify=RIGHT)
                self.lb2.place(x=30, y=110)
                ...
                self.dish = Label(self.drink, text="DISH\t\t\t RATE  DISH \t\t RATE", font=self.font5, bg="#4F6367",
                                  fg="#EEF5DB", justify=RIGHT)
                self.dish.place(x=30, y=50)
                self.lb1 = Label(self.drink, text="COFFEE\t\t \t 25      COLD COFFEE\t 40", font=self.font4,
                                 bg="#4F6367",
                                 fg="#EEF5DB", justify=RIGHT)
                self.lb1.place(x=30, y=80)
                self.lb2 = Label(self.drink, text="TEA\t\t\t 10      COLD DRINKS\t 25", font=self.font4, bg="#4F6367",
                                 fg="#EEF5DB", justify=RIGHT)
                self.lb2.place(x=30, y=110)
                self.lb3 = Label(self.drink, text="LEMON SODA\t\t 15      BUTTER SKOTCH SHAKE 40", font=self.font4,
                                 bg="#4F6367",
                                 fg="#EEF5DB", justify=RIGHT)
                self.lb3.place(x=30, y=140)
                # =================CHAPATI===================
                ...
                self.dish = Label(self.chap, text="DISH\t\t\t RATE  DISH \t\t RATE", font=self.font5, bg="#4F6367",
                                  fg="#EEF5DB", justify=RIGHT)
                self.dish.place(x=30, y=50)
                self.lb1 = Label(self.chap, text="ROTI\t\t\t 8            PANEER PRATHA\t40", font=self.font4,
                                 bg="#4F6367",
                                 fg="#EEF5DB", justify=RIGHT)
                self.lb1.place(x=30, y=80)
        ...
        class About:
            def __init__(self, window):
                ...
                # ===================Main label=============
                self.l1 = Label(self.right,
                                text="The main objective of this 4 week project is to develop a standalone model, ",
                                font=("cinzel", 18, "bold"), bg="#4F6367", bd=8, fg="#EEF5DB", justify=CENTER)
                self.l1.place(x=0, y=0)
                self.l1 = Label(self.right,
                                text="main objective of this 4 week project is to develop a standalone model, ",
                                font=("cinzel", 18, "bold"), bg="#4F6367", bd=8, fg="#EEF5DB", justify=CENTER)
                self.l1.place(x=0, y=40)
                self.l1 = Label(self.right,
                                text="which deals with The  “Restaurant Billing System”. The system has two parts ",
                                font=("cinzel", 18, "bold"), bg="#4F6367", bd=8, fg="#EEF5DB", justify=CENTER)
                self.l1.place(x=0, y=80)
                self.l1 = Label(self.right, text="first for the customers and the other for the management side. The ",
                                font=("cinzel", 18, "bold"), bg="#4F6367", bd=8, fg="#EEF5DB", justify=CENTER)
                self.l1.place(x=0, y=120)
                self.l1 = Label(self.right,
                                text="of delivery he desires and reserve meal for that specific time, and at the management ",
                                font=("cinzel", 18, "bold"), bg="#4F6367", bd=8, fg="#EEF5DB", justify=CENTER)
                self.l1.place(x=0, y=160)
                self.l1 = Label(self.right,
                                text="side the staff is allowed to edit information regarding menu list, price,",
                                font=("cinzel", 18, "bold"), bg="#4F6367", bd=8, fg="#EEF5DB", justify=CENTER)
                self.l1.place(x=0, y=200)
                self.l1 = Label(self.right,
                                text="assigning cook, maintain information regarding the orders placed, etc.",
                                font=("cinzel", 18, "bold"), bg="#4F6367", bd=8, fg="#EEF5DB", justify=CENTER)
